...
Pod::Spec.new do |s|
  ...
  #                  DESC
  s.homepage     = "https://github.com/doublenode/DNIncrementalStore"
  ...
  #
  s.source       = { :git => "https://github.com/doublenode/DNIncrementalStore.git", :tag => s.version.to_s }
  ...
  #
  s.source_files = 'Classes/*.{h,m}','Categories/*.{h,m}','Vendor/**/*.{h,m}'
